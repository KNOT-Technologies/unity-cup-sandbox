...
const Navbar = () => {
  ...
  const navItems = ['Home', 'History', 'Hospitality', 'Tickets', 'Information'];
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black pt-4">
      <div className="relative max-w-full px-8">
        <div className="flex items-center h-24">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 hidden md:flex items-center justify-center space-x-8">
            {/* Menu Items */}
