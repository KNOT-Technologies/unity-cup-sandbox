            ...
            relative sm:absolute z-10"
                >
                  ...
                  backdrop-blur-xl border border-amber-500/20 transition-[border,background] duration-300 delay-200"
                    ...
                    <div
                        className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 translate-y-full
            border-[10px] border-transparent border-t-gray-800/20 z-10 hidden sm:block"
                    ></div>
                </motion.div>
            </div>
        </Portal>
