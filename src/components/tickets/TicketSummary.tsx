...
const TicketSummary: React.FC<TicketSummaryProps> = ({
  ...
  const translationFee = useCredits ? 1 : 5; // 1 credit or $5 per person
      ...
      <div className="p-5 flex flex-col h-full relative z-10">
        ...
        {selectedSeats.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center text-center p-6">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500/20 to-amber-500/5 
            ...
            <p className="text-sm text-white/40 mt-1">Click on available seats to add tickets</p>
          </div>
        ) : (
